...
def predict(cfg, trained_model_dict):
    ...
    test_set = DatasetFromFolder_mri_general(cfg=cfg, target_dict_path=cfg.NET_DATALOADER.TARGET_DICT, filelist=image_file_list,  direction=cfg.NET_DATALOADER.DIRECTION, mode = 'test')
    print(len(test_set))
