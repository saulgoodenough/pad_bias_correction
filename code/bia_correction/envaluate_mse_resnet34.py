...
save_path = '../../resnet3d34_predict/range/mse_adam/2021-11-21_not_corrected/'
...
whole_path = '../../resnet3d34_predict/range/mse_adam/2021-11-21_age_predict.csv'
plot_title = 'resnet3d34 range 38-86 with MSE loss'
save_path = '../../resnet3d34_predict/range/mse_adam/2021-11-21_linear_corrected/'
whole_path_corrected = correct_age(whole_path, save_path, method = method)
corr_list_linear1, corr_list_linear1_zscore = plot_sequence(whole_path_corrected, plot_title, save_path, if_bar_xlabel = False, if_bar_ylabel = False, if_scatter_xlabel = False, if_scatter_ylabel = False)
...
whole_path = '../../resnet3d34_predict/range/mse_adam/2021-11-21_age_predict.csv'
plot_title = 'resnet3d34 range 38-86 with MSE loss'
save_path = '../../resnet3d34_predict/range/mse_adam/2021-11-21_square_corrected/'
whole_path_corrected = correct_age(whole_path, save_path, method = method)
...
whole_path = '../../resnet3d34_predict/range/mse_adam/2021-11-21_age_predict.csv'
plot_title = 'resnet3d34 range 38-86 with MSE loss'
save_path = '../../resnet3d34_predict/range/mse_adam/2021-11-21_method2_linear_corrected/'
whole_path_corrected = correct_age(whole_path, save_path, method = method)
...
whole_path = '../../resnet3d34_predict/range/mse_adam/2021-11-21_age_predict.csv'
plot_title = 'resnet3d34 range 38-86 with MSE loss'
save_path = '../../resnet3d34_predict/range/mse_adam/2021-11-21_method2_square_corrected/'
whole_path_corrected = correct_age(whole_path, save_path, method = method)
