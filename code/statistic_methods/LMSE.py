...
predict_save_path = '../../statistic_methods_predict/lmse/predict_data.npz'
csv_save_path = '../../statistic_methods_predict/lmse/ukbiobank'
model_save_dir = '../../statistic_methods_predict/lmse/'

logger = setup_logger("Least mean square sparse", model_save_dir, if_train=True)
...
clf = make_pipeline(StandardScaler(with_mean=True), LinearRegression())
