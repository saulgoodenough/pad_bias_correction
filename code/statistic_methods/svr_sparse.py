...
predict_save_path = '../../statistic_methods_predict/svr_sparse/predict_data.npz'
csv_save_path = '../../statistic_methods_predict/svr_sparse/ukbiobank'
model_save_dir = '../../statistic_methods_predict/svr_sparse/'

logger = setup_logger("svr sparse", model_save_dir, if_train=True)
...
clf = make_pipeline(StandardScaler(with_mean=False), SVR(degree=12, C=1e5, epsilon = 0.001))
