...
predict_save_path = '../../statistic_methods_predict/lasso/predict_data.npz'
csv_save_path = '../../statistic_methods_predict/lasso/ukbiobank'
model_save_dir = '../../statistic_methods_predict/lasso/'

logger = setup_logger("lasso", model_save_dir, if_train=True)
...
clf= Lasso(alpha=0.1, tol=1e-5, warm_start=True)
