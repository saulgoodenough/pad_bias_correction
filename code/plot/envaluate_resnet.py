...
# resnet3d range
whole_path = '../../resnet3d_predict/range/whole/2021-07-06_age_predict.csv'
age_statistics_real(whole_path)
age_statistics(whole_path, 'resnet3d_range 38-86')
compute_error(whole_path, 'resnet3d_range 38-86')
compute_error_all(whole_path, 'resnet3d_range 38-86')
compute_class_accuracy(whole_path, 'resnet3d_range 38-86')

# resnet3d range sampler
whole_path = '../../resnet3d_predict/range_sampler/whole/2021-07-13_age_predict.csv'
age_statistics(whole_path, 'sample resnet3d range 38-86')
compute_error(whole_path, 'sample resnet3d range 38-86')
compute_error_all(whole_path, 'sample resnet3d range 38-86')
compute_class_accuracy(whole_path, 'sample resnet3d range 38-86')
