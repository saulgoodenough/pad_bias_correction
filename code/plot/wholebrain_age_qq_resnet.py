...
'''
# sfcn
whole_path = '../../sfcn_predict/whole/2021-07-01_age_predict.csv'
#left_path = '../../sfcn_predict/left/2021-06-26_age_predict.csv'
#right_path = '../../sfcn_predict/right/2021-06-26_age_predict.csv'
...
plot_whole_brain(whole_path, 'resnet3d range 38-86')
#plot_left_right(left_path, right_path, 'resnet3d range 30-90')
...
plot_whole_brain(whole_path, 'sample resnet3d range 42-82')
#plot_left_right(left_path, right_path, 'resnet3d range 30-90')
...
plot_whole_brain(whole_path, 'sample resnet3d range 38-86')
