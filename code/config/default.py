...
_C.MSD_MODEL.DILATION_MOD = [8, 3, 3]
...
_C.NET_DATALOADER.BATCH_SIZE = 4
...
_C.MSD_TRAIN.DEVICE_ID = '0,1'#'0,1,2'
_C.MSD_TRAIN.DATA_DEVICE_ID = [0,1]#[0,1,2]
