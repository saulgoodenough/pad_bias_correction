...
_C.NET_MODEL.TYPE = 'SFCN' # 'MSD3D', 'RESNET3D'
...
_C.NET_TRAIN.WHOLE_PRETRAIN_MODEL_PATH = '../../sfcn_model/range/whole/pytorch_model_22_2021-04-19'
_C.NET_TRAIN.LEFT_PRETRAIN_MODEL_PATH = '../../sfcn_model/range/left/pytorch_model_22_2021-04-19'
_C.NET_TRAIN.RIGHT_PRETRAIN_MODEL_PATH = '../../sfcn_model/range/right/pytorch_model_22_2021-04-19'
_C.NET_TRAIN.EPOCHS = 130 #100
...
_C.SOLVER.LR_DECAY = 0.3
_C.SOLVER.LR_PERIOD = 30
...
_C.NET_TRAIN.NET_OUTPUT_DIR = "../../sfcn_model/range/"
_C.NET_TRAIN.WHOLE_NET_OUTPUT_DIR = "../../sfcn_model/range/whole/"
_C.NET_TRAIN.LEFT_NET_OUTPUT_DIR = "../../sfcn_model/range/left/"
_C.NET_TRAIN.RIGHT_NET_OUTPUT_DIR = "../../sfcn_model/range/right/"

_C.NET_PREDICT = CN()
_C.NET_PREDICT.WHOLE_MODEL = '../../sfcn_model/range/whole/pytorch_model_128_2021-06-20'
_C.NET_PREDICT.WHOLE_DIR = "../../sfcn_predict/range/whole/"
_C.NET_PREDICT.LEFT_MODEL = '../../sfcn_model/range/left/pytorch_model_128_2021-06-20'
_C.NET_PREDICT.LEFT_DIR = "../../sfcn_predict/range/left/"
_C.NET_PREDICT.RIGHT_MODEL = '../../sfcn_model/range/right/pytorch_model_130_2021-06-20'
_C.NET_PREDICT.RIGHT_DIR = "../../sfcn_predict/range/right/"

# ---------------------------------------------------------------------------- #
# Visualization
# ---------------------------------------------------------------------------- #
_C.VISUALIZER = CN()
_C.VISUALIZER.WHOLE_ENV = 'SFCN_WHOLE'
_C.VISUALIZER.LEFT_ENV = 'SFCN_LEFT'
_C.VISUALIZER.RIGHT_ENV = 'SFCN_RIGHT'
